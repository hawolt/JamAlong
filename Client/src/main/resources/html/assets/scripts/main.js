...
window.onload = function () {
  ...
  for (let i = 0; i < showlist.length; i++) {
    showlist[i].addEventListener("click", function () {
      console.log("clicked");
      let display = document.getElementById("jamalong").dataset.display;
      if (display == "userlist")
        document.getElementById("jamalong").dataset.display = "chat";
      else document.getElementById("jamalong").dataset.display = "userlist";
      if (display == null) {
        document.getElementById("jamalong").dataset.display = "userlist";
      }
      display = document.getElementById("jamalong").dataset.display;
